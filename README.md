...
__init__:  Function initialize the instance of protein_RNA_interaction class with PDB file name (with path), protein chain and RNA chain;
f1_header: Function extract the header of PDB file;
f2_atom_coords: Extract the atom records from PDB file in the format of a list;
f3_extract_seqres: Extract SEQRES records of the PDB file;
...
f7_energy2: Using the output dataframe of f6_proteinRNAcontact2 function and amino acid and nucleotide van der Waals parameter file energy is generated. The 'Vdw_energy' column contains the energy values.;
